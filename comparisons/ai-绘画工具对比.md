...
updated: 2026-05-23
type: comparison
tags: [comparison, design-tool]
sources: [raw/articles/2026-05-23-ai-绘画工具对比.md]
---

# AI 绘画工具对比

主流 AI 绘画工具的功能对比和使用指南。与 [[stitch2]]、[[暗壳ai]] 等 AI 设计工具互补，本页聚焦通用图像生成工具的横向对比。
...
> 专用设计场景可参考 [[stitch2]]（UI 设计）和 [[暗壳ai]]（室内设计），它们提供更垂直的工作流集成。
