...
- [[hermes-parallel-isolation]] — 并行隔离模式：Worktree vs Backend 隔离
- [[hermes-subagent-orchestration]] — 子代理编排：delegate_task + 两阶段审查

## Comparisons

- [[stitch2-vs-暗壳ai]] — Stitch 2.0 vs 暗壳AI：通用 UI 设计 vs 垂直室内设计
- [[supabase-vs-firebase]] — Supabase vs Firebase：开源 Postgres vs Google BaaS
...
- `2026-05-05-gitnexus.md` — GitNexus 工具介绍
- `2026-05-05-obscura-browser.md` — Obscura 浏览器自动化
- `2026-05-05-pretext-text-measurement.md` — Pretext 文本测量
- `2026-05-05-stitch2-AI设计.md` — Stitch 2.0 AI 设计工具
- `2026-05-05-暗壳AI室内设计.md` — 暗壳AI 室内设计
- `2026-05-06-anthropic-prompting-best-practices.md` — Anthropic 提示工程最佳实践
- `2026-05-06-codex-cli-goal命令.md` — Codex CLI goal 命令
- `2026-05-06-hereos-ai.md` — Hereos AI 工具
- `2026-05-07-windsurf-codemaps.md` — Windsurf Codemaps
