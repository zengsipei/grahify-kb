...
sources:
  - raw/articles/2026-05-23-nextjs-最佳实践.md
---

# Next.js 最佳实践

基于 Next.js 16 App Router 的开发最佳实践总结。Next.js 作为全栈 React 框架，在 [[知识库架构设计]] 中常被选作 Wiki/文档系统的前端技术栈，也可用于构建 [[暗壳ai]] 类 AI 设计平台的后端服务。
