...
updated: 2026-05-23
type: concept
tags: [knowledge-mgmt, visualization]
sources:
  - raw/articles/2026-05-23-markdown-进阶语法.md
---
...
Mermaid 是 Markdown 中嵌入图表的核心方式，也是知识管理中可视化呈现的关键技术（参见 [[graphify]]）。
...
- [[ai-agent-输出格式研究]] — Markdown 线性输出与人类空间认知的结构性错配，以及 HTML 作为替代输出格式的探索
- [[graphify]] — 基于 Mermaid 和知识图谱的可视化工具，将 Markdown 内容转化为交互式图谱
