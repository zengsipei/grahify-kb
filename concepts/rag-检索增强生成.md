...
updated: 2026-05-23
type: concept
tags: [knowledge-mgmt, inference]
sources: [raw/articles/2026-05-23-rag-检索增强生成.md]
---
...
向量化后的文档存储在 [[向量数据库入门]] 中，以支持高效的相似度检索。
...
- [[向量数据库入门]] — RAG 架构中向量存储与检索的基础
- [[graphify]] — 知识图谱工具，可作为 RAG 的图检索增强手段（GraphRAG）
