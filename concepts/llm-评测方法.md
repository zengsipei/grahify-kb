...
updated: 2026-05-23
type: concept
tags: [inference, ai-agent]
sources: [raw/articles/2026-05-23-llm-评测方法.md]
---
...
安全性评测与 [[ai-安全与对齐]] 中的红队测试和三层安全框架紧密相关，确保模型不会输出有害内容。
...
设计高质量的评判 prompt 是 LLM-as-Judge 的关键，[[anthropic-prompting-best-practices]] 中的提示工程原则同样适用于评判 prompt 的构建——清晰的结构化指令和明确的评分标准能显著提升评判一致性。
