...
sources: [raw/articles/2026-05-23-git-工作流最佳实践.md]
---

# Git 工作流最佳实践

团队协作中使用 Git 的最佳实践，涵盖分支管理、提交规范和常用技巧。在 AI 辅助开发场景下，规范的 Git 工作流是 [[hermes-agentic-workflows]] 中多代理协作与自动化部署的基础。
...
> 使用约定式提交，让 Git 历史清晰可读。结合 [[ai-编程工具对比]] 中的 AI 编码助手，可自动生成符合规范的 commit message。
