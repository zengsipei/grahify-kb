...
sources: [raw/articles/2026-05-23-prisma-orm-使用指南.md]
---
...
- [[supabase-vs-firebase]] — Supabase（Postgres）和 Firebase 作为后端时的 ORM 选择比较，Prisma 可与 Supabase Postgres 直接配合
- [[nextjs-最佳实践]] — Next.js 项目中数据库层常选用 Prisma 作为 ORM，两者结合实现全栈类型安全
